	...
	<div class="col-md-6 col-lg-3 mb-4">
		<div class="card h-100">
			...
			<div class="card-footer">
				<button class="btn btn-primary" style="width: 100%; margin-bottom: 0px;" onclick="window.open('` + project.link + `');">` + project.link_text + `</button>
			</div>
		</div>
	</div>
	`
...
// This is all stuff from the old layout that I don't want to delete yet
// //Canvas obj & ctx
// var cnv;
// var ctx;
// //Colours
